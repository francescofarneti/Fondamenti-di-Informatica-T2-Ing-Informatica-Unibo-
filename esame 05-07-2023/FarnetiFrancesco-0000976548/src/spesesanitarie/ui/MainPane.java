...
public class MainPane extends BorderPane {
	...
	private void myHandle() {
		...
		List<DocumentoDiSpesa>lista =controller.filtraPer(tipologia);
		areaDettagli.appendText("Totale spese per questa tipologia: "+Formatters.itPriceFormatter.format(controller.totaleSpesePer(tipologia))+"\n\n");
		areaDettagli.appendText("Dettaglio spese che contengono voci per questa tipologia:\n\n");
		for(DocumentoDiSpesa documento : lista) {
			areaDettagli.appendText(documento.toString());
		}
	...
	private void impostaAreaSommario() {
		...
		//
		String formattedDetr = "detraibili: "+Formatters.itPriceFormatter.format(detr); 		// FAKE, DA IMPLEMENTARE
		String formattedNonDetr = "non detraibili: "+Formatters.itPriceFormatter.format(nonDetr); ; 	// FAKE, DA IMPLEMENTARE
		//
